...
\begin{enumerate}
    ...
    \item \textbf{Next:} run one Workspace E2 task as an H200 integrity pilot and, if structurally valid, complete the remaining frozen train tasks without using the pilot's effect direction to select suites;
