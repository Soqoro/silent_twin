...
\begin{enumerate}
    ...
    \item \textbf{Next:} audit and, only if scientifically ready, freeze E2 train to estimate whether source-aligned evidence transfers into prohibited effects and whether \method{} closes that increment, without treating E2 as a route around the failed E1 gate;
